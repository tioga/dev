...
public class ExceptionUtilsTest {
    ...
    public void testAssertNotZeroLength() {

        ExceptionUtils.assertNotZeroLength("something", "whatever");

        try {
            ExceptionUtils.assertNotZeroLength(null, "whatever");
        } catch (NullPointerException e) {
            assertEquals(e.getMessage(), "The value \"whatever\" cannot be null.");
        }

        try {
            ExceptionUtils.assertNotZeroLength("", "whatever");
        } catch (IllegalArgumentException e) {
            assertEquals(e.getMessage(), "The value \"whatever\" is an empty string.");
        }
    }

    public void testAssertNotZeroLengthCustom() {

        ExceptionUtils.assertNotZeroLength("something", "whatever", ApiNotFoundException.class, ApiBadRequestException.class);

        try {
            ExceptionUtils.assertNotZeroLength(null, "whatever", ApiNotFoundException.class, ApiBadRequestException.class);
        } catch (ApiNotFoundException e) {
            assertEquals(e.getMessage(), "The value \"whatever\" cannot be null.");
        }

        try {
            ExceptionUtils.assertNotZeroLength("", "whatever", ApiNotFoundException.class, ApiBadRequestException.class);
